...
// ── VERSION STAMP ─────────────────────────────────────────────
// Bump this string on every deploy to auto-wipe the journal on first load
...
function App() {
  ...
  var _savedState = (function() {
    try {
      ...
      // Wipe journal if this is a new game version
      ...
      /*#__PURE__*/React.createElement("div", { style: { marginLeft: "auto", display: "flex", gap: 6, alignItems: "center" } },
        ["All","M","F"].map(function(s){
          return /*#__PURE__*/React.createElement("button", {
            ...
            style: { background:filterSex===s?"#3a2810":"transparent",
              border:"1px solid "+(filterSex===s?"#d4942a":"#4a3a28"),
